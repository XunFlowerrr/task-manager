...
const log = logger('projectInvitation.ts');
export async function sendInvitation(req, res) {
    ...
    try {
        ...
        await query(`INSERT INTO project_invitation (invitation_id, project_id, user_id, invited_by)
       VALUES ($1, $2, $3, $4)`, [invitationId, projectId, userId, req.user.userId]);
